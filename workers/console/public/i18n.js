...
(function () {
  ...
  var DICT = {
    zh: {
      '{n} of {m} search visits': '{m} 次搜索来访中有 {n} 次',
      'Invalid traffic': '无效流量',
      'Datacenter traffic': '数据中心流量',
      'No-interaction visits': '无交互访问',
      'Forged search referrals': '伪造搜索来源',
      'of pageviews': '占浏览量',
      'of search visits': '占搜索来访',
      'alert line {x}': '告警线 {x}',
      'over the {x} alert line': '已超过 {x} 告警线',
      'no search traffic in this period': '本时段没有搜索来访',
      'Sample too small for alerts — shown for reference only.': '样本量过小,未启用告警,仅供参考。',
      'Pageviews judged bot or suspect': '被判定为机器人或可疑的浏览量',
      'From cloud/hosting networks rather than home or mobile ISPs': '来自云/托管网络,而非家庭或移动运营商',
      'No click, scroll or page-leave in the whole session': '整场会话没有点击、滚动或离开事件',
      'Claim a search-engine referral that looks forged': '声称来自搜索引擎,但来源结构可疑',
    'Bot-detection checks that fired on suspicious traffic — one visit can trip several.': '在可疑流量上触发的机器人检测项——一次访问可能触发多项。',
    ...
    ja: {
      '{n} of {m} search visits': '検索流入 {m} 件中 {n} 件',
      'Invalid traffic': '無効トラフィック',
      'Datacenter traffic': 'データセンター経由',
      'No-interaction visits': '操作なしの訪問',
      'Forged search referrals': '偽装された検索流入',
      'of pageviews': 'ページビュー中',
      'of search visits': '検索流入中',
      'alert line {x}': '警告ライン {x}',
      'over the {x} alert line': '警告ライン {x} を超過',
      'no search traffic in this period': 'この期間に検索流入なし',
      'Sample too small for alerts — shown for reference only.': 'サンプルが少ないため警告は無効です（参考値）。',
      'Pageviews judged bot or suspect': 'ボットまたは疑わしいと判定されたPV',
      'From cloud/hosting networks rather than home or mobile ISPs': '家庭・モバイル回線ではなくクラウド/ホスティング回線から',
      'No click, scroll or page-leave in the whole session': 'セッション全体でクリック・スクロール・離脱が一切ない',
      'Claim a search-engine referral that looks forged': '検索エンジンからの流入を装っているが偽装の疑い',
    'Bot-detection checks that fired on suspicious traffic — one visit can trip several.': '不審なトラフィックで検出されたボット判定項目 — 1回の訪問で複数該当することがあります。',
    ...
    ko: {
      '{n} of {m} search visits': '검색 유입 {m}건 중 {n}건',
      'Invalid traffic': '무효 트래픽',
      'Datacenter traffic': '데이터센터 트래픽',
      'No-interaction visits': '상호작용 없는 방문',
      'Forged search referrals': '위조된 검색 유입',
      'of pageviews': '페이지뷰 중',
      'of search visits': '검색 방문 중',
      'alert line {x}': '경고 기준 {x}',
      'over the {x} alert line': '{x} 경고 기준 초과',
      'no search traffic in this period': '이 기간에 검색 유입 없음',
      'Sample too small for alerts — shown for reference only.': '표본이 적어 경고는 비활성화됩니다(참고용).',
      'Pageviews judged bot or suspect': '봇 또는 의심으로 판정된 페이지뷰',
      'From cloud/hosting networks rather than home or mobile ISPs': '가정·모바일 ISP가 아닌 클라우드/호스팅 네트워크에서',
      'No click, scroll or page-leave in the whole session': '세션 전체에서 클릭·스크롤·이탈이 전혀 없음',
      'Claim a search-engine referral that looks forged': '검색엔진 유입을 주장하지만 위조로 보임',
    'Bot-detection checks that fired on suspicious traffic — one visit can trip several.': '의심스러운 트래픽에서 감지된 봇 탐지 항목 — 한 번의 방문에서 여러 항목이 걸릴 수 있습니다.',
    ...
    de: {
      '{n} of {m} search visits': '{n} von {m} Suchbesuchen',
      'Invalid traffic': 'Ungültiger Traffic',
      'Datacenter traffic': 'Rechenzentrums-Traffic',
      'No-interaction visits': 'Besuche ohne Interaktion',
      'Forged search referrals': 'Gefälschte Suchverweise',
      'of pageviews': 'der Seitenaufrufe',
      'of search visits': 'der Suchbesuche',
      'alert line {x}': 'Warnschwelle {x}',
      'over the {x} alert line': 'über der Warnschwelle {x}',
      'no search traffic in this period': 'kein Suchtraffic in diesem Zeitraum',
      'Sample too small for alerts — shown for reference only.': 'Stichprobe zu klein für Warnungen – nur zur Orientierung.',
      'Pageviews judged bot or suspect': 'Als Bot oder verdächtig eingestufte Seitenaufrufe',
      'From cloud/hosting networks rather than home or mobile ISPs': 'Aus Cloud-/Hosting-Netzen statt Heim- oder Mobilfunkanbietern',
      'No click, scroll or page-leave in the whole session': 'Kein Klick, Scrollen oder Seitenverlassen in der ganzen Sitzung',
      'Claim a search-engine referral that looks forged': 'Geben einen Suchmaschinen-Verweis an, der gefälscht wirkt',
    'Bot-detection checks that fired on suspicious traffic — one visit can trip several.': 'Bot-Erkennungsprüfungen, die bei verdächtigem Traffic ausgelöst wurden – ein Besuch kann mehrere auslösen.',
    ...
    fr: {
      '{n} of {m} search visits': '{n} sur {m} visites de recherche',
      'Invalid traffic': 'Trafic non valide',
      'Datacenter traffic': 'Trafic de centres de données',
      'No-interaction visits': 'Visites sans interaction',
      'Forged search referrals': 'Référents de recherche falsifiés',
      'of pageviews': 'des pages vues',
      'of search visits': 'des visites de recherche',
      'alert line {x}': 'seuil d’alerte {x}',
      'over the {x} alert line': 'au-dessus du seuil de {x}',
      'no search traffic in this period': 'aucun trafic de recherche sur cette période',
      'Sample too small for alerts — shown for reference only.': 'Échantillon trop petit pour les alertes — à titre indicatif.',
      'Pageviews judged bot or suspect': 'Pages vues jugées bot ou suspectes',
      'From cloud/hosting networks rather than home or mobile ISPs': 'Depuis des réseaux cloud/hébergement plutôt que des FAI résidentiels ou mobiles',
      'No click, scroll or page-leave in the whole session': 'Aucun clic, défilement ni départ de page durant toute la session',
      'Claim a search-engine referral that looks forged': 'Annoncent un référent de moteur de recherche qui semble falsifié',
    'Bot-detection checks that fired on suspicious traffic — one visit can trip several.': 'Contrôles de détection de bots déclenchés sur le trafic suspect — une seule visite peut en déclencher plusieurs.',
    ...
    es: {
      '{n} of {m} search visits': '{n} de {m} visitas de búsqueda',
      'Invalid traffic': 'Tráfico no válido',
      'Datacenter traffic': 'Tráfico de centros de datos',
      'No-interaction visits': 'Visitas sin interacción',
      'Forged search referrals': 'Referencias de búsqueda falsificadas',
      'of pageviews': 'de las páginas vistas',
      'of search visits': 'de las visitas de búsqueda',
      'alert line {x}': 'umbral de alerta {x}',
      'over the {x} alert line': 'por encima del umbral de {x}',
      'no search traffic in this period': 'sin tráfico de búsqueda en este período',
      'Sample too small for alerts — shown for reference only.': 'Muestra demasiado pequeña para alertas: solo como referencia.',
      'Pageviews judged bot or suspect': 'Páginas vistas juzgadas bot o sospechosas',
      'From cloud/hosting networks rather than home or mobile ISPs': 'Desde redes de nube/alojamiento en lugar de ISP domésticos o móviles',
      'No click, scroll or page-leave in the whole session': 'Sin clic, desplazamiento ni salida de página en toda la sesión',
      'Claim a search-engine referral that looks forged': 'Afirman una referencia de buscador que parece falsificada',
    'Bot-detection checks that fired on suspicious traffic — one visit can trip several.': 'Comprobaciones de detección de bots activadas por tráfico sospechoso: una sola visita puede activar varias.',
