...
(function () {
  ...
  var DICT = {
    zh: {
      'API tokens': 'API 令牌',
      'token-help': ' — 只读凭证,供 CLI、MCP 服务器(让你自己的 Chatbot 查询数据)以及其他集成使用。仅在创建时显示一次。',
      'Token name': '令牌名称',
      'Scope': '适用范围',
      'All my sites': '我的全部站点',
      'Create token': '创建令牌',
      'Copy it now — it cannot be shown again.': '请立即复制——它不会再次显示。',
      'No tokens yet.': '尚无令牌。',
      // channels
      'Channels': '渠道',
      'Channel': '渠道',
      ...
      'Web Vitals': '核心网页指标',
      'loads': '次加载',
      'Slowest pages (LCP p75)': '最慢页面(LCP p75)',
      'Good': '良好',
      'Needs improvement': '需改进',
      'Poor': '较差',
      'Real-user Core Web Vitals from clean traffic — the same metrics Google Search uses. p75 = 75% of page loads were at least this fast.': '来自干净流量的真实用户核心网页指标——与谷歌搜索采用的指标一致。p75 = 75% 的页面加载至少达到该速度。',
      '*INP is approximated from the slowest observed interaction.': '*INP 为近似值,取观测到的最慢一次交互。',
      'Largest Contentful Paint — when the main content became visible': 'Largest Contentful Paint——主要内容可见的时间',
      'Interaction latency (approximation: slowest observed interaction)': '交互延迟(近似:观测到的最慢一次交互)',
      'Cumulative Layout Shift — how much the page jumped around': 'Cumulative Layout Shift——页面布局跳动程度',
      'First Contentful Paint': 'First Contentful Paint 首次内容绘制',
      'Time To First Byte — server response speed': 'Time To First Byte——服务器响应速度',
      // public share
      'Public dashboard': '公开仪表盘',
      'Sharing is ON — anyone with this link can view a read-only dashboard (aggregates only, no visitor-level data).': '分享已开启——持有此链接的任何人都可查看只读仪表盘(仅聚合数据,不含访客级明细)。',
      'Create a read-only public link for this site — overview, trend, top pages, channels, quality and Web Vitals. No visitor-level data is exposed, and you can revoke the link at any time.': '为该站点创建只读公开链接——概览、趋势、热门页面、渠道、流量质量与核心网页指标。不暴露访客级数据,可随时撤销链接。',
      'Enable sharing': '开启分享',
      'Disable sharing': '关闭分享',
      'Rotate link': '更换链接',
      'Copy': '复制',
      'Copied!': '已复制!',
      'public dashboard': '公开仪表盘',
      'Visitors per day': '每日访客',
      'This dashboard link is invalid or has been disabled.': '该仪表盘链接无效或已被关闭。',
      ...
      'Mechanical pointer': '机械化指针轨迹',
      'Pointer moved with machine-like dynamics: constant speed, zero curvature, or clicks landing with no nearby movement': '指针以机器方式移动:匀速、零曲率,或点击落点附近没有任何指针移动',
      'Session identity drift': '会话内身份漂移',
      'Browser family, OS or language changed within one session — impossible for a real visitor; a replayed session cookie or an environment-rotating farm': '同一会话内浏览器/操作系统/语言发生变化——真实访客不可能;是被重放的会话 Cookie 或轮换环境的流量农场',
      'all sites': '全部站点',
      'used': '最近使用',
      'never used': '从未使用',
      'Revoke': '吊销',
      'Revoke this token? Anything using it stops working immediately.': '确定吊销此令牌?正在使用它的一切将立即失效。',
      'Could not create the token.': '无法创建令牌。',
      'not your site': '该站点不属于你',
      'Crawler directory': '爬虫目录',
      'botdir-help': ' — 可选。导入公开的爬虫目录,即可按用途标注爬虫流量(搜索 / AI 训练 / SEO / 广告)。仅做分类:不影响打分、判定或广告防护。',
      'Directory JSON file': '目录 JSON 文件',
      '…or paste the JSON': '…或直接粘贴 JSON',
      'Import directory': '导入目录',
      'Remove': '移除',
      'No directory imported — crawler traffic is not categorised.': '尚未导入目录——爬虫流量未做分类。',
      'bots imported': '个爬虫已导入',
      'skipped': '条跳过',
      'updated': '更新于',
      'Could not read that file.': '无法读取该文件。',
      'Choose a file or paste the JSON first.': '请先选择文件或粘贴 JSON。',
      'That is not valid JSON.': '这不是有效的 JSON。',
      'Import failed.': '导入失败。',
      'no bot entries recognised in that file': '该文件中未识别到任何爬虫条目',
      'Imported {n} bots.': '已导入 {n} 个爬虫。',
      'Directory removed.': '目录已移除。',
      'Crawlers by category': '爬虫分类',
      'Cloudflare edge requests': 'Cloudflare 边缘请求',
      'cf-help': ' — 可选,进阶。埋点脚本只能看到浏览器执行了 JavaScript 的访客。AI 爬虫和采集器抓走 HTML 就走,因此从不出现在统计里。但 Cloudflare 全都数到了:填一个只读 API 令牌,每天的定时任务就会把这些请求数拉回来,面板即可显示脚本漏掉的部分。不填则一切照旧。',
      'cf-steps': '在 Cloudflare 控制台:<b>My Profile → API Tokens → Create Token → Create Custom Token</b>。只给下面这两个权限,都是只读:',
      'cf-steps2': '在 <i>Zone Resources</i> 里选择你站点所在的 zone(或账号下全部 zone),创建令牌后粘贴到下方。',
      'Open Cloudflare API Tokens ↗': '打开 Cloudflare API Tokens ↗',
      'Cloudflare API token': 'Cloudflare API 令牌',
      'Save & check': '保存并检查',
      'Re-check': '重新检查',
      '(a token is saved — leave blank to keep it)': '(已保存令牌——留空即保持不变)',
      'Not configured — the dashboard shows only what the tracking script recorded.': '未配置——面板只显示埋点脚本记录到的数据。',
      'Saved. The first pull runs with tonight’s daily job.': '已保存。首次拉取会在今晚的每日任务中执行。',
      'Last check failed': '上次检查失败',
      'Last pull': '上次拉取',
      'site-days': '个站点-日',
      'sites matched': '个站点已匹配',
      'zones visible': '个 zone 可见',
      'checking…': '检查中…',
      'Could not verify that token.': '无法验证该令牌。',
      'Token works. Matched {n} site(s): ': '令牌可用。匹配到 {n} 个站点:',
      'Token works, but none of your sites are on a zone it can see. Check the token’s Zone Resources.': '令牌可用,但你的站点都不在它能看到的 zone 里。请检查令牌的 Zone Resources 设置。',
      'Token removed.': '令牌已移除。',
      'What the script never saw': '统计脚本看不见的部分',
      'Requests Cloudflare served for this site, next to the pageviews the tracking script reported. The difference is HTML that was fetched without ever running JavaScript — AI crawlers, scrapers and feed readers. Descriptive only: none of this affects scoring, verdicts or ad protection.': 'Cloudflare 为本站点实际服务的请求数,与埋点脚本上报的 PV 并列。差额就是被抓走、但从未执行 JavaScript 的 HTML——AI 爬虫、采集器、RSS 阅读器。仅供观察:不影响打分、判定或广告防护。',
      'Measure': '指标',
      'Requests': '请求数',
      'Edge HTML requests': '边缘 HTML 请求',
      'Browser pageviews': '浏览器 PV',
      'Gap — fetched, never ran JS': '差额——抓走了,但没执行 JS',
      'All edge requests (assets included)': '全部边缘请求(含静态资源)',
      'User agent': 'User-Agent',
      'Identified crawler traffic grouped by what the crawler is for. Classification only — these visits are scored exactly as before.': '已识别的爬虫流量,按爬虫用途分组。仅做分类——这些访问的打分与此前完全一致。',
      'Category': '类别',
      'Share': '占比',
      'Search engine': '搜索引擎',
      'AI training': 'AI 训练',
      ...
      '· within the current filter': '· 仅当前筛选范围内', 'High invalid-traffic share': '无效流量占比过高', 'Lots of datacenter traffic': '机房流量过多', 'Forged search-referrer traffic': '伪造搜索来源的流量', 'Many no-interaction visits': '大量无交互访问', 'Implausibly low bounce rate': '跳出率低得不合常理', 'Very high pages per visitor': '人均浏览页数异常高', 'One source dominates': '单一来源占比过高', 'alert-invalid': '{share} 的浏览量是机器人/可疑流量(告警线 {threshold})。', 'alert-datacenter': '{share} 的浏览量来自云服务/主机商 IP(告警线 {threshold})。', 'alert-fake-search': '{share} 的浏览量声称来自搜索引擎,但特征像伪造(告警线 {threshold})。', 'alert-zero-interaction': '{share} 的浏览量没有任何指针/键盘输入,也没有离开信号(告警线 {threshold})。', 'alert-bounce-low': '单页跳出率只有 {share} —— 真实受众很少低于 {threshold},通常是自动化的多次访问。', 'alert-ppv': '人均 {value} 页(告警线 {threshold})—— 可能是抓取行为。', 'alert-source-concentration': '“{key}” 占会话数的 {share}(告警线 {threshold})—— 检查是否有推荐垃圾流量或伪造来源。', 'Sample too small for alerts — shown for reference only.': '样本量过小,未启用告警,仅供参考。',
    ...
    'Bot-detection checks that fired on suspicious traffic — one visit can trip several.': '在可疑流量上触发的机器人检测项——一次访问可能触发多项。',
      ...
      'counted': '计入', 'Visible dwell, incl. exit page': '可见停留,含离开页', 'uv-approx': '跨多天时按每日去重访客求和,同一访客出现在三天里会被算三次。站点仪表盘上的数字才是精确的。', 'Embed code': '接入代码', 'The tracking snippet for this site': '这个站点的埋点代码', 'Add this to every page, before </head> or at the end of <body>.': '把这段代码加到每个页面,放在 </head> 之前或 </body> 末尾。', 'Run self-check': '运行自检', 'embed-note': 'data-api 必须是你的采集域名;data-adguard 仅在做广告防护时有意义。改动会在约一小时内随 f.js 缓存刷新到已嵌入的页面。', 'Off': '关闭', 'Balanced — bots & crawlers': '平衡——机器人与爬虫', 'Aggressive — everything not clean': '激进——所有非正常流量', 'Strictest — clean + interacted': '最严格——正常且有交互', 'Sessions*': '会话*', '* Sessions that STARTED in this period, from session-level attribution. The Sessions card above counts sessions that recorded a pageview, so the two differ by sessions that only sent behaviour beacons — almost entirely bots.': '* 本期内开始的会话,按会话级归因统计。上方的会话卡片统计的是有浏览记录的会话,两者之差是只发了行为信标、没有浏览的会话——几乎全是机器人。', 'Unidentifiable desktop': '无法识别的桌面端', 'A desktop device whose user agent names no known browser family and no identifiable OS. Real desktop browsers are one of six families (including the Chromium-based Chinese ones); the three conditions together measured 0.1% of healthy traffic': '桌面设备,但 UA 里既没有任何已知浏览器标识,也认不出操作系统。真实桌面浏览器必然属于六大家族之一(国产浏览器也是 Chromium 内核,同样带标识);三个条件同时成立在健康流量中实测占 0.1%。', 'Non-bot PV': '非机器人PV', 'Non-bot visitors': '非机器人访客', 'City': '城市', 'Country': '国家/地区', 'Region': '地区', 'Entry page': '入口页', 'Exit page': '出口页', 'First-touch source': '首次触点来源', 'First-touch medium': '首次触点媒介', 'First-touch campaign': '首次触点广告系列', 'Path': '路径', 'Bounces': '跳出', 'Screen': '屏幕', '+ filter': '+ 筛选', 'ads always load — protection disabled': '广告始终加载——防护已关闭', 'load ads only for clean traffic (blocks all suspect + bad)': '仅对正常流量加载广告(拦截所有可疑+恶意)', 'block bots/crawlers always; suspect only without interaction': '始终拦截机器人/爬虫;可疑流量仅在无交互时拦截', 'load ads only for clean traffic that also interacted': '仅对有交互的正常流量加载广告', 'Estimated impact over this period': '本期预估影响', 'pageviews': '次浏览', 'fp-explainer': '"预估误伤率" = 被拦流量中出现指针或键盘输入的占比。指针信号拆分之前记录的访问会退回旧的"任意交互"口径,那包含滚动——爬虫也会滚动,所以那些日期偏高。', 'Blocked/day': '每日拦截', 'saving…': '保存中…', 'save failed': '保存失败', 'saved, applies on next page load': '已保存,下次页面加载生效', 'online now': '在线', 'views': '浏览', 'Self-check': '自检', 'Sign out': '退出登录', 'Your sites': '你的站点', 'New site': '新建站点', 'Site ranking · clean traffic': '站点排名 · 清洗流量', 'Add a site': '添加站点', 'Site name': '站点名称', 'Domains (comma-separated)': '域名(逗号分隔)', 'Ad protection mode': '广告防护模式', 'AdSense client (optional)': 'AdSense 客户端(可选)', 'Timezone': '时区', '(can\'t be changed later)': '(创建后不可更改)', 'Engagement threshold (seconds)': '参与阈值(秒)', 'Create site': '创建站点', 'Site created — embed this snippet:': '站点已创建——嵌入以下代码：', 'Site & branding': '站点与品牌', 'Brand name (header + homepage)': '品牌名称(页头+首页)', 'Primary domain': '主域名', 'Description': '描述', 'Logo — light (for dark backgrounds)': 'Logo — 浅色(用于深色背景)', 'Logo — dark (for light backgrounds)': 'Logo — 深色(用于浅色背景)', 'Default timezone for new sites': '新站点的默认时区', 'Save default timezone': '保存默认时区', 'Save': '保存', 'AI analysis reports': 'AI 分析报告', 'Provider (API format)': '提供商(API 格式)', 'OpenAI-compatible': 'OpenAI 兼容', 'Model name': '模型名称', 'API base URL': 'API 基础地址', '(optional — blank uses the provider default)': '(可选——留空则用提供商默认)', 'API key': 'API 密钥', 'Report language': '报告语言', 'Save AI settings': '保存 AI 设置', 'Homepage settings': '首页设置', 'Site': '站点', 'External clean': '外部清洗', 'Internal (mutual)': '内部(互访)', 'Total PV': '总浏览量', 'saved': '已保存', 'pick a valid timezone from the list': '请从列表中选择有效时区', 'Run self-check ↗': '运行自检 ↗', 'My Blog': '我的博客', 'failed': '失败', '(a key is saved — leave blank to keep it)': '(已保存密钥——留空则保留)', '(not set)': '(未设置)', 'Just deployed?': '刚部署完？', 'No sites yet — use the “＋ New site” button to add one.': '还没有站点——用"＋ 新建站点"按钮添加一个。', 'Run the self-check ↗': '运行自检 ↗', 'Human': '真人', '← dashboard': '← 仪表盘', 'Visitor journeys': '访客轨迹', 'Find visitors': '查找访客', 'Filter': '筛选', 'Journey': '轨迹', 'First seen': '首次出现', 'no visitors matched in this period': '此时间段内无匹配访客', 'Events (lifetime)': '事件(累计)', 'Sessions shown': '显示的会话', 'Worst verdict': '最差判定', 'Bot score': '机器人评分', 'no events in the selected period — try a longer range': '所选时间段内无事件——试试更长的范围', 'bounced': '跳出', 'Filter by page path, e.g. /pay — trailing * matches a prefix (/pay*)': '按页面路径筛选,如 /pay —— 结尾 * 匹配前缀(/pay*)', 'Shows visitors with a pageview matching the path in the selected period; leave empty for all visitors. Click a visitor to see the full journey.': '显示在所选时间段内有匹配该路径浏览的访客;留空显示全部。点击访客查看完整轨迹。', 'page': '页面', 'leave': '离开', 'out': '外链', 'stayed': '停留', 'scrolled': '滚动', 'from': '来自', 'source:': '来源：', 'pages': '页', 'matching': '匹配', 'events in this period': '个事件(所选时间段)', '(capped at 300 — narrow the period for more)': '(上限 300 —— 缩小时间段可看更多)', 'self-hosted analytics · sign in': '自托管分析 · 登录', 'Continue with Google': '使用 Google 继续', 'Continue with GitHub': '使用 GitHub 继续', 'That account is not an admin — login not allowed.': '该账号不是管理员——不允许登录。', 'Login session expired — please try again.': '登录会话已过期——请重试。', 'Login was interrupted — please try again.': '登录被中断——请重试。', 'No verified email was returned by the provider.': '提供商未返回已验证的邮箱。', 'OAuth exchange failed — check the provider configuration.': 'OAuth 交换失败——请检查提供商配置。', 'Could not read your profile from the provider.': '无法从提供商读取你的资料。', 'Sign-in failed — please try again.': '登录失败——请重试。', 'Sign-in failed': '登录失败', 'No login provider is configured. The deployer must set up Google or GitHub OAuth — see DEPLOY.md.': '未配置任何登录方式。部署者需要配置 Google 或 GitHub OAuth——见 DEPLOY.md。', 'Could not reach the server.': '无法连接服务器。', 'Download data': '下载数据', 'Preparing…': '准备中…', 'Language': '语言', 'Recent anomalies (vs baseline)': '近期异常(对比基线)',
      // console UX pass: KPI cards (short labels + tooltips), suspicious visitors, journeys
      'unique people': '独立访客数', 'visits': '访问次数', 'all traffic': '含全部流量', 'depth': '访问深度',
      'visible dwell': '可见停留', 'first → last event': '首个→末个事件', 'GA4 style': 'GA4 口径', 'Plausible style': 'Plausible 口径',
      'Bounce (engaged)': '跳出率(参与)', 'Bounce (1-page)': '跳出率(单页)', 'custom events': '自定义事件', 'from events with revenue': '来自带收入的事件',
      'Distinct visitors (by visitor id) in this range, bots and crawlers excluded': '本时段内的独立访客数(按访客 ID),已排除机器人与爬虫',
      'Visits — a new session starts after 30 minutes idle or at midnight': '访问次数——闲置 30 分钟或跨天后开始新会话',
      'Every recorded pageview, including traffic later judged invalid': '记录到的全部浏览量,含事后判定为无效的流量',
      'Pageviews divided by visitors': '浏览量 ÷ 访客数',
      'Average time the page was actually visible per visit, exit page included (measured, not inferred)': '每次访问中页面真正可见的平均时长,含离开页(实测,非推断)',
      'Classic session length: first to last event in the visit (Universal Analytics / Plausible definition — exit page counts as 0)': '经典会话时长:访问中首个到末个事件的间隔(UA / Plausible 口径——离开页计 0)',
      'Share of pageviews not judged bot or crawler': '未被判定为机器人或爬虫的浏览量占比',
      'Visits with no engagement: under 10s, no second page, no conversion (GA4 definition)': '无参与的访问:不足 10 秒、无第二页、无转化(GA4 口径)',
      'Visits that saw exactly one page (Universal Analytics / Plausible definition)': '只看了一页的访问(UA / Plausible 口径)',
      'Visits claiming a Google/Bing referral that the forgery checks rejected': '声称来自 Google/Bing 但被伪造检测拒绝的访问',
      'Custom events sent by your site (signup, purchase …) from clean traffic': '你的站点发送的自定义事件(注册、购买……),仅计干净流量',
      'Sum of the revenue property on custom events, in USD': '自定义事件 revenue 属性之和(美元)',
      'Suspicious visitors': '可疑访客', 'All visitors →': '全部访客 →', 'Show all': '显示全部', 'Show fewer': '收起', 'Journey timeline': '轨迹时间线',
      'Visitors whose bot score reached 30 or more in this range, worst first — click one to replay its journey.': '本时段机器人评分达到 30 分以上的访客,最差的在前——点击可回放其轨迹。',
      "How much of this range's traffic was invalid, which checks caught it, and how close each ratio is to its alert line.": '本时段有多少流量是无效的、由哪些检测项捕获、各项比例距离告警线还有多远。',
      'Direct': '直接访问',
      'All verdicts': '全部判定', 'Goals': '目标', 'Show more': '显示更多', 'times in': '时间按',
      'Pageviews in period': '本时段浏览量', 'Sessions (lifetime)': '会话(累计)', 'Evidence': '证据', 'datacenter network': '数据中心网络',
      'clicks': '次点击', 'JS errors': 'JS 报错', 'rage clicks': '暴躁点击', 'dead clicks': '无效点击', 'form': '表单', 'submit': '提交',
      'entry': '入口', 'exit': '出口', 'Path or verdict filters apply to the list only; the journey always shows every event.': '路径/判定筛选只作用于列表;轨迹页始终显示全部事件。',
      'Show visitors who opened a page, or only a verdict class. Click a visitor to replay the full journey.': '查看打开过某页面的访客,或只看某一判定类别。点击访客可回放完整轨迹。',
      ...
      'Shadow mode': '影子模式',
      // funnel v2
      'No breakdown': '不分段', 'By source': '按来源', 'By country': '按国家/地区', 'By device': '按设备', 'By browser': '按浏览器', 'By OS': '按操作系统',
      'Clean traffic only — bots and crawlers never enter a funnel. Each drop shows what the people who left were doing on that step.': '仅统计干净流量——机器人与爬虫不会进入漏斗。每一处流失都会显示离开的人在那一步上做了什么。',
      'Funnel name': '漏斗名称', 'Delete': '删除', 'Showing the 100 most recent.': '仅显示最近 100 位。', 'Save funnel': '保存漏斗', 'Unsaved funnel': '未保存的漏斗', 'Delete this funnel?': '确定删除这个漏斗?',
      'Page path': '页面路径', 'Remove step': '删除此步', 'Funnel': '漏斗', 'Page': '页面',
      'dropped here': '在此流失', 'rage-clicked': '有暴躁点击', 'clicked something dead': '点了没反应的元素', 'hit a JS error': '遇到 JS 报错',
      'see who →': '看看是谁 →', 'after': '距上一步',
      'Conversion by': '分段转化率 ·', 'Entered': '进入', 'Converted': '转化', 'Rate': '转化率', 'Biggest loss': '最大流失', 'step': '第',
      'Worst converting segment with enough volume is highlighted.': '已高亮样本量足够、转化率最差的分段。',
      'Dropped at step': '流失于第', 'Reached this step': '到达该步时间',
      'Open a visitor to replay everything they did before they left.': '点开任一访客,可回放他离开前做过的一切。',
      'Settings': '设置',
      'Waiting for the first visit': '等待第一次访问', 'Copy snippet': '复制代码', 'Copied': '已复制', 'listening for events…': '正在监听事件…',
      'onboard-help': '这个站点还没有记录到任何事件。把下面的代码加到每个页面(<code>&lt;/head&gt;</code> 之前或 <code>&lt;/body&gt;</code> 末尾),打开一次你的网站,这个页面会自动切换到仪表盘。',
      'onboard-note': '这段代码与站点列表创建后显示的相同。<b>data-api</b> 必须是你的采集域名;<b>data-adguard</b> 仅在做广告防护时有意义。',
      'populated by the hourly rollup — check back after :05': '由每小时的汇总任务填充——过了整点 05 分再看',
      'anom-dist': '{what}:“{top}” 占干净{unit}的 {now}%,基线为 {base}%',
      'Clean traffic collapsed onto one device profile': '干净流量集中到单一设备特征', 'Clean visits concentrated on one landing page': '干净访问集中到单一落地页',
      'Storage & retention': '存储与保留', 'Run purge now': '立即清理', 'Refresh': '刷新', 'days': '天', 'keep forever': '永久保留',
      'Estimated size': '预估大小', 'exact: wrangler d1 info': '精确值:wrangler d1 info', 'Raw event rows': '原始事件行数', 'monthly partitions': '个月分区',
      'Visitor profiles': '访客档案', 'kept': '保留', 'idle limit': '闲置上限', 'Month': '月份', 'Rows': '行数', 'heartbeats': '行为心跳', 'bot / crawler': '机器人/爬虫',
      'Est. size': '预估大小', 'Windows:': '保留窗口:', 'raw events': '原始事件', 'idle profiles': '闲置档案', 'purging…': '清理中…', 'Done:': '完成:', 'partitions dropped': '个月分区已删除', 'sessions': '会话', 'profiles': '档案',
      'more remains; run again or let the nightly job continue': '还有剩余;可再次运行,或交给每晚的定时任务继续',
      'The daily job applies them at 03:30 UTC; whole months past the raw window are dropped at once, the rest is trimmed in batches.': '每日任务在 03:30 UTC 执行:超出原始窗口的整月分区一次性删除,其余按批次修剪。',
      'Run the retention purge now? Raw rows outside the configured windows are deleted permanently; dashboards are unaffected.': '现在执行保留清理?超出窗口的原始数据会被永久删除;仪表盘的统计不受影响。',
      'storage-help': ' — 填满 D1 的是原始事件行(含索引约 0.8 KB/行;算上行为心跳,一次浏览会产生多行)。仪表盘读取的汇总表永久保留;下面的窗口只决定访客轨迹和可疑访客下钻能回看多久。在 <code>config.local.toml [retention]</code> 中设置后重新部署 cron 与 console。', 'Overview': '概览', 'Trend': '趋势', 'Audience': '受众', 'Campaigns': '广告系列', 'Suspicious': '可疑访客',
      'Add at least 2 steps with a value, then Run.': '至少填写 2 个步骤,再点「运行」。',
      'Suggested from your homepage and first goal — edit the steps freely; your edits are remembered.': '根据首页和第一个目标自动生成——步骤可随意修改,修改会被记住。',
    ...
    ja: {
      'API tokens': 'API トークン',
      'token-help': ' — 読み取り専用の認証情報。CLI・MCP サーバー（自分のチャットボットからデータを参照）・その他の連携に使用します。作成時に一度だけ表示されます。',
      'Token name': 'トークン名',
      'Scope': '適用範囲',
      'All my sites': '自分のすべてのサイト',
      'Create token': 'トークンを作成',
      'Copy it now — it cannot be shown again.': '今すぐコピーしてください — 再表示はできません。',
      'No tokens yet.': 'トークンはまだありません。',
      'all sites': '全サイト',
      'used': '最終使用',
      'never used': '未使用',
      'Revoke': '失効',
      'Revoke this token? Anything using it stops working immediately.': 'このトークンを失効しますか？使用中のものはすぐに動作しなくなります。',
      'Could not create the token.': 'トークンを作成できませんでした。',
      'not your site': 'そのサイトの所有者ではありません',
      'Crawler directory': 'クローラーディレクトリ',
      'botdir-help': ' — 任意。公開のボット目録を取り込むと、クローラーを用途別（検索／AI学習／SEO／広告）に分類できます。分類のみで、スコアや判定、広告保護には影響しません。',
      'Directory JSON file': 'ディレクトリ JSON ファイル',
      '…or paste the JSON': '…または JSON を貼り付け',
      'Import directory': 'ディレクトリを取り込む',
      'Remove': '削除',
      'No directory imported — crawler traffic is not categorised.': 'ディレクトリ未取り込み — クローラーは分類されません。',
      'bots imported': '件のボットを取り込み',
      'skipped': '件スキップ',
      'updated': '更新',
      'Could not read that file.': 'そのファイルを読み込めません。',
      'Choose a file or paste the JSON first.': '先にファイルを選ぶか JSON を貼り付けてください。',
      'That is not valid JSON.': '有効な JSON ではありません。',
      'Import failed.': '取り込みに失敗しました。',
      'no bot entries recognised in that file': 'そのファイルからボット項目を認識できませんでした',
      'Imported {n} bots.': '{n} 件のボットを取り込みました。',
      'Directory removed.': 'ディレクトリを削除しました。',
      'Crawlers by category': 'カテゴリ別クローラー',
      'Cloudflare edge requests': 'Cloudflare エッジリクエスト',
      'cf-help': ' — 任意、上級者向け。計測スクリプトは JavaScript を実行したブラウザーしか捕捉できません。AI クローラーやスクレイパーは HTML を取得して去るため、まったく現れません。Cloudflare はそのすべてを数えています。読み取り専用の API トークンを登録すると、毎日のジョブがそのリクエスト数を取得し、スクリプトが取りこぼした分をダッシュボードに表示できます。空のままでも何も変わりません。',
      'cf-steps': 'Cloudflare ダッシュボードで <b>My Profile → API Tokens → Create Token → Create Custom Token</b>。次の 2 つの権限だけを、いずれも読み取り専用で付与します:',
      'cf-steps2': '<i>Zone Resources</i> でサイトが属するゾーン（またはアカウント内の全ゾーン）を選び、トークンを作成して下に貼り付けてください。',
      'Open Cloudflare API Tokens ↗': 'Cloudflare API Tokens を開く ↗',
      'Cloudflare API token': 'Cloudflare API トークン',
      'Save & check': '保存して確認',
      'Re-check': '再確認',
      '(a token is saved — leave blank to keep it)': '（トークンは保存済み — 空欄なら維持されます）',
      'Not configured — the dashboard shows only what the tracking script recorded.': '未設定 — ダッシュボードは計測スクリプトが記録した分のみを表示します。',
      'Saved. The first pull runs with tonight’s daily job.': '保存しました。最初の取得は今夜の日次ジョブで実行されます。',
      'Last check failed': '前回の確認は失敗しました',
      'Last pull': '前回の取得',
      'site-days': 'サイト日',
      'sites matched': 'サイトが一致',
      'zones visible': 'ゾーンが参照可能',
      'checking…': '確認中…',
      'Could not verify that token.': 'そのトークンを検証できませんでした。',
      'Token works. Matched {n} site(s): ': 'トークンは有効です。{n} 件のサイトに一致: ',
      'Token works, but none of your sites are on a zone it can see. Check the token’s Zone Resources.': 'トークンは有効ですが、参照できるゾーンにあなたのサイトが 1 つもありません。トークンの Zone Resources を確認してください。',
      'Token removed.': 'トークンを削除しました。',
      'What the script never saw': 'スクリプトが見られなかったもの',
      'Requests Cloudflare served for this site, next to the pageviews the tracking script reported. The difference is HTML that was fetched without ever running JavaScript — AI crawlers, scrapers and feed readers. Descriptive only: none of this affects scoring, verdicts or ad protection.': 'Cloudflare がこのサイトに対して実際に配信したリクエスト数と、計測スクリプトが報告したページビューの比較です。差分は、JavaScript を一度も実行せずに取得された HTML — AI クローラー、スクレイパー、フィードリーダーです。記述のみで、スコアや判定、広告保護には影響しません。',
      'Measure': '指標',
      'Requests': 'リクエスト数',
      'Edge HTML requests': 'エッジ HTML リクエスト',
      'Browser pageviews': 'ブラウザーのページビュー',
      'Gap — fetched, never ran JS': '差分 — 取得されたが JS は未実行',
      'All edge requests (assets included)': '全エッジリクエスト（アセット含む）',
      'User agent': 'ユーザーエージェント',
      'Identified crawler traffic grouped by what the crawler is for. Classification only — these visits are scored exactly as before.': '識別されたクローラーを用途別に集計。分類のみで、これらの訪問のスコアは従来どおりです。',
      'Category': 'カテゴリ',
      'Share': '割合',
      ...
      'AI search': 'AI 検索',
      'SEO tool': 'SEO ツール',
      'Ad verification': '広告検証',
      'Monitoring': '監視',
      'Security scanner': 'セキュリティスキャナ',
      'Archiving': 'アーカイブ',
    ...
    ko: {
      'API tokens': 'API 토큰',
      'token-help': ' — 읽기 전용 자격 증명. CLI, MCP 서버(내 챗봇에서 데이터 조회), 기타 연동에 사용합니다. 생성 시 한 번만 표시됩니다.',
      'Token name': '토큰 이름',
      'Scope': '적용 범위',
      'All my sites': '내 모든 사이트',
      'Create token': '토큰 생성',
      'Copy it now — it cannot be shown again.': '지금 복사하세요 — 다시 표시되지 않습니다.',
      'No tokens yet.': '아직 토큰이 없습니다.',
      'all sites': '모든 사이트',
      'used': '최근 사용',
      'never used': '사용된 적 없음',
      'Revoke': '해지',
      'Revoke this token? Anything using it stops working immediately.': '이 토큰을 해지할까요? 이를 사용 중인 모든 것이 즉시 중단됩니다.',
      'Could not create the token.': '토큰을 만들 수 없습니다.',
      'not your site': '본인의 사이트가 아닙니다',
      'Crawler directory': '크롤러 디렉터리',
      'botdir-help': ' — 선택. 공개 봇 목록을 가져오면 크롤러를 용도별(검색/AI 학습/SEO/광고)로 분류합니다. 분류만 하며 점수·판정·광고 보호에는 영향을 주지 않습니다.',
      'Directory JSON file': '디렉터리 JSON 파일',
      '…or paste the JSON': '…또는 JSON 붙여넣기',
      'Import directory': '디렉터리 가져오기',
      'Remove': '제거',
      'No directory imported — crawler traffic is not categorised.': '가져온 디렉터리 없음 — 크롤러가 분류되지 않습니다.',
      'bots imported': '개 봇 가져옴',
      'skipped': '건 건너뜀',
      'updated': '업데이트',
      'Could not read that file.': '파일을 읽을 수 없습니다.',
      'Choose a file or paste the JSON first.': '먼저 파일을 선택하거나 JSON을 붙여넣으세요.',
      'That is not valid JSON.': '유효한 JSON이 아닙니다.',
      'Import failed.': '가져오기에 실패했습니다.',
      'no bot entries recognised in that file': '해당 파일에서 봇 항목을 인식하지 못했습니다',
      'Imported {n} bots.': '{n}개 봇을 가져왔습니다.',
      'Directory removed.': '디렉터리를 제거했습니다.',
      'Crawlers by category': '카테고리별 크롤러',
      'Cloudflare edge requests': 'Cloudflare 엣지 요청',
      'cf-help': ' — 선택, 고급. 추적 스크립트는 브라우저가 JavaScript를 실행한 방문자만 볼 수 있습니다. AI 크롤러와 스크래퍼는 HTML만 가져가고 떠나므로 전혀 나타나지 않습니다. Cloudflare는 그 모두를 세었습니다. 읽기 전용 API 토큰을 추가하면 매일 실행되는 작업이 그 요청 수를 가져와, 스크립트가 놓친 부분을 대시보드에 표시할 수 있습니다. 비워 두어도 아무것도 달라지지 않습니다.',
      'cf-steps': 'Cloudflare 대시보드에서 <b>My Profile → API Tokens → Create Token → Create Custom Token</b>. 아래 두 권한만, 모두 읽기 전용으로 부여하세요:',
      'cf-steps2': '<i>Zone Resources</i>에서 사이트가 속한 존(또는 계정의 모든 존)을 선택한 뒤 토큰을 만들어 아래에 붙여 넣으세요.',
      'Open Cloudflare API Tokens ↗': 'Cloudflare API Tokens 열기 ↗',
      'Cloudflare API token': 'Cloudflare API 토큰',
      'Save & check': '저장 후 확인',
      'Re-check': '다시 확인',
      '(a token is saved — leave blank to keep it)': '(토큰이 저장되어 있습니다 — 비워 두면 유지됩니다)',
      'Not configured — the dashboard shows only what the tracking script recorded.': '설정되지 않음 — 대시보드는 추적 스크립트가 기록한 것만 표시합니다.',
      'Saved. The first pull runs with tonight’s daily job.': '저장했습니다. 첫 수집은 오늘 밤 일일 작업에서 실행됩니다.',
      'Last check failed': '마지막 확인 실패',
      'Last pull': '마지막 수집',
      'site-days': '사이트-일',
      'sites matched': '개 사이트 일치',
      'zones visible': '개 존 확인 가능',
      'checking…': '확인 중…',
      'Could not verify that token.': '해당 토큰을 확인할 수 없습니다.',
      'Token works. Matched {n} site(s): ': '토큰이 작동합니다. {n}개 사이트 일치: ',
      'Token works, but none of your sites are on a zone it can see. Check the token’s Zone Resources.': '토큰은 작동하지만, 볼 수 있는 존에 회원님의 사이트가 하나도 없습니다. 토큰의 Zone Resources를 확인하세요.',
      'Token removed.': '토큰을 삭제했습니다.',
      'What the script never saw': '스크립트가 보지 못한 것',
      'Requests Cloudflare served for this site, next to the pageviews the tracking script reported. The difference is HTML that was fetched without ever running JavaScript — AI crawlers, scrapers and feed readers. Descriptive only: none of this affects scoring, verdicts or ad protection.': 'Cloudflare가 이 사이트에 실제로 제공한 요청 수와 추적 스크립트가 보고한 페이지뷰를 나란히 보여 줍니다. 차이는 JavaScript를 한 번도 실행하지 않고 가져간 HTML — AI 크롤러, 스크래퍼, 피드 리더입니다. 설명용일 뿐이며 점수·판정·광고 보호에는 영향을 주지 않습니다.',
      'Measure': '지표',
      'Requests': '요청 수',
      'Edge HTML requests': '엣지 HTML 요청',
      'Browser pageviews': '브라우저 페이지뷰',
      'Gap — fetched, never ran JS': '차이 — 가져갔지만 JS 미실행',
      'All edge requests (assets included)': '전체 엣지 요청(자산 포함)',
      'User agent': '사용자 에이전트',
      'Identified crawler traffic grouped by what the crawler is for. Classification only — these visits are scored exactly as before.': '식별된 크롤러 트래픽을 용도별로 묶은 것입니다. 분류만 하며 이 방문의 점수는 이전과 동일합니다.',
      'Category': '카테고리',
      'Share': '비율',
      'Search engine': '검색엔진',
      'AI training': 'AI 학습',
      ...
      'AI search': 'AI 검색',
      'SEO tool': 'SEO 도구',
      'Ad verification': '광고 검증',
      'Monitoring': '모니터링',
      'Security scanner': '보안 스캐너',
      'Archiving': '아카이빙',
    ...
    de: {
      ...
      'token-help': ' — schreibgeschützte Zugangsdaten für die CLI, den MCP-Server (damit Ihr eigener Chatbot diese Daten abfragen kann) und andere Integrationen. Wird nur einmal bei der Erstellung angezeigt.',
      'Token name': 'Token-Name',
      'Scope': 'Geltungsbereich',
      'All my sites': 'Alle meine Websites',
      'Create token': 'Token erstellen',
      'Copy it now — it cannot be shown again.': 'Jetzt kopieren – es wird nicht erneut angezeigt.',
      'No tokens yet.': 'Noch keine Tokens.',
      'all sites': 'alle Websites',
      'used': 'zuletzt verwendet',
      'never used': 'nie verwendet',
      'Revoke': 'Widerrufen',
      'Revoke this token? Anything using it stops working immediately.': 'Dieses Token widerrufen? Alles, was es nutzt, funktioniert sofort nicht mehr.',
      'Could not create the token.': 'Token konnte nicht erstellt werden.',
      'not your site': 'Nicht Ihre Website',
      'Crawler directory': 'Crawler-Verzeichnis',
      'botdir-help': ' — optional. Importieren Sie einen öffentlichen Bot-Katalog, um Crawler-Traffic nach Art zu kennzeichnen (Suche / KI-Training / SEO / Werbung). Nur Klassifizierung: ohne Einfluss auf Bewertung, Urteil oder Anzeigenschutz.',
      'Directory JSON file': 'Verzeichnis-JSON-Datei',
      '…or paste the JSON': '…oder JSON einfügen',
      'Import directory': 'Verzeichnis importieren',
      'Remove': 'Entfernen',
      'No directory imported — crawler traffic is not categorised.': 'Kein Verzeichnis importiert – Crawler-Traffic wird nicht kategorisiert.',
      'bots imported': 'Bots importiert',
      'skipped': 'übersprungen',
      'updated': 'aktualisiert',
      'Could not read that file.': 'Datei konnte nicht gelesen werden.',
      'Choose a file or paste the JSON first.': 'Bitte zuerst eine Datei wählen oder JSON einfügen.',
      'That is not valid JSON.': 'Das ist kein gültiges JSON.',
      'Import failed.': 'Import fehlgeschlagen.',
      'no bot entries recognised in that file': 'In dieser Datei wurden keine Bot-Einträge erkannt',
      'Imported {n} bots.': '{n} Bots importiert.',
      'Directory removed.': 'Verzeichnis entfernt.',
      'Crawlers by category': 'Crawler nach Kategorie',
      'Cloudflare edge requests': 'Cloudflare-Edge-Anfragen',
      'cf-help': ' — optional, fortgeschritten. Das Tracking-Skript sieht nur Besucher, deren Browser JavaScript ausgeführt hat. KI-Crawler und Scraper holen sich Ihr HTML und verschwinden, tauchen also nie auf. Cloudflare hat sie alle gezählt: Hinterlegen Sie ein schreibgeschütztes API-Token, und der tägliche Job holt diese Anfragezahlen, sodass Ihr Dashboard zeigen kann, was dem Skript entgangen ist. Lassen Sie es leer, ändert sich nichts.',
      'cf-steps': 'Im Cloudflare-Dashboard: <b>My Profile → API Tokens → Create Token → Create Custom Token</b>. Vergeben Sie genau diese zwei Berechtigungen, beide nur lesend:',
      'cf-steps2': 'Wählen Sie unter <i>Zone Resources</i> die Zonen Ihrer Websites (oder alle Zonen des Kontos), erstellen Sie das Token und fügen Sie es unten ein.',
      'Open Cloudflare API Tokens ↗': 'Cloudflare API Tokens öffnen ↗',
      'Cloudflare API token': 'Cloudflare-API-Token',
      'Save & check': 'Speichern & prüfen',
      'Re-check': 'Erneut prüfen',
      '(a token is saved — leave blank to keep it)': '(ein Token ist gespeichert — leer lassen, um es zu behalten)',
      'Not configured — the dashboard shows only what the tracking script recorded.': 'Nicht konfiguriert — das Dashboard zeigt nur, was das Tracking-Skript erfasst hat.',
      'Saved. The first pull runs with tonight’s daily job.': 'Gespeichert. Der erste Abruf läuft mit dem heutigen nächtlichen Job.',
      'Last check failed': 'Letzte Prüfung fehlgeschlagen',
      'Last pull': 'Letzter Abruf',
      'site-days': 'Website-Tage',
      'sites matched': 'Websites zugeordnet',
      'zones visible': 'Zonen sichtbar',
      'checking…': 'wird geprüft…',
      'Could not verify that token.': 'Dieses Token konnte nicht überprüft werden.',
      'Token works. Matched {n} site(s): ': 'Token funktioniert. {n} Website(s) zugeordnet: ',
      'Token works, but none of your sites are on a zone it can see. Check the token’s Zone Resources.': 'Das Token funktioniert, aber keine Ihrer Websites liegt in einer Zone, die es sehen kann. Prüfen Sie die Zone Resources des Tokens.',
      'Token removed.': 'Token entfernt.',
      'What the script never saw': 'Was das Skript nie gesehen hat',
      'Requests Cloudflare served for this site, next to the pageviews the tracking script reported. The difference is HTML that was fetched without ever running JavaScript — AI crawlers, scrapers and feed readers. Descriptive only: none of this affects scoring, verdicts or ad protection.': 'Anfragen, die Cloudflare für diese Website ausgeliefert hat, neben den Seitenaufrufen, die das Tracking-Skript gemeldet hat. Die Differenz ist HTML, das abgerufen wurde, ohne je JavaScript auszuführen — KI-Crawler, Scraper und Feedreader. Rein beschreibend: nichts davon beeinflusst Bewertung, Urteil oder Anzeigenschutz.',
      'Measure': 'Kennzahl',
      'Requests': 'Anfragen',
      'Edge HTML requests': 'Edge-HTML-Anfragen',
      'Browser pageviews': 'Browser-Seitenaufrufe',
      'Gap — fetched, never ran JS': 'Differenz — abgerufen, nie JS ausgeführt',
      'All edge requests (assets included)': 'Alle Edge-Anfragen (inkl. Assets)',
      'User agent': 'User-Agent',
      'Identified crawler traffic grouped by what the crawler is for. Classification only — these visits are scored exactly as before.': 'Erkannter Crawler-Traffic nach Verwendungszweck. Nur Klassifizierung – diese Besuche werden genau wie zuvor bewertet.',
      'Category': 'Kategorie',
      'Share': 'Anteil',
      ...
      'AI search': 'KI-Suche',
      'SEO tool': 'SEO-Tool',
      'Ad verification': 'Anzeigenprüfung',
      'Monitoring': 'Überwachung',
      'Security scanner': 'Sicherheitsscanner',
    ...
    fr: {
      ...
      'token-help': ' — identifiants en lecture seule pour la CLI, le serveur MCP (afin que votre propre chatbot puisse interroger ces données) et d\'autres intégrations. Affiché une seule fois à la création.',
      'Token name': 'Nom du jeton',
      'Scope': 'Portée',
      'All my sites': 'Tous mes sites',
      'Create token': 'Créer un jeton',
      'Copy it now — it cannot be shown again.': 'Copiez-le maintenant — il ne sera plus affiché.',
      'No tokens yet.': 'Aucun jeton pour le moment.',
      'all sites': 'tous les sites',
      'used': 'utilisé',
      'never used': 'jamais utilisé',
      'Revoke': 'Révoquer',
      'Revoke this token? Anything using it stops working immediately.': 'Révoquer ce jeton ? Tout ce qui l’utilise cessera de fonctionner immédiatement.',
      'Could not create the token.': 'Impossible de créer le jeton.',
      'not your site': 'Ce site ne vous appartient pas',
      'Crawler directory': 'Répertoire de robots',
      'botdir-help': ' — facultatif. Importez un catalogue public de robots pour étiqueter le trafic des robots par type (recherche / entraînement IA / SEO / publicité). Classification uniquement : sans effet sur le score, le verdict ou la protection publicitaire.',
      'Directory JSON file': 'Fichier JSON du répertoire',
      '…or paste the JSON': '…ou collez le JSON',
      'Import directory': 'Importer le répertoire',
      'Remove': 'Supprimer',
      'No directory imported — crawler traffic is not categorised.': 'Aucun répertoire importé — le trafic des robots n’est pas catégorisé.',
      'bots imported': 'robots importés',
      'skipped': 'ignorés',
      'updated': 'mis à jour',
      'Could not read that file.': 'Impossible de lire ce fichier.',
      'Choose a file or paste the JSON first.': 'Choisissez d’abord un fichier ou collez le JSON.',
      'That is not valid JSON.': 'Ce n’est pas du JSON valide.',
      'Import failed.': 'Échec de l’importation.',
      'no bot entries recognised in that file': 'aucune entrée de robot reconnue dans ce fichier',
      'Imported {n} bots.': '{n} robots importés.',
      'Directory removed.': 'Répertoire supprimé.',
      'Crawlers by category': 'Robots par catégorie',
      'Cloudflare edge requests': 'Requêtes edge Cloudflare',
      'cf-help': ' — facultatif, avancé. Le script de mesure ne voit que les visiteurs dont le navigateur a exécuté JavaScript. Les robots d’IA et les scrapers récupèrent votre HTML puis repartent : ils n’apparaissent jamais. Cloudflare, lui, les a tous comptés. Ajoutez un jeton d’API en lecture seule et la tâche quotidienne récupère ces volumes de requêtes, pour que votre tableau de bord montre ce que le script a manqué. Laissez vide et rien ne change.',
      'cf-steps': 'Dans le tableau de bord Cloudflare : <b>My Profile → API Tokens → Create Token → Create Custom Token</b>. Accordez exactement ces deux permissions, toutes deux en lecture seule :',
      'cf-steps2': 'Sous <i>Zone Resources</i>, choisissez les zones de vos sites (ou toutes les zones du compte), puis créez le jeton et collez-le ci-dessous.',
      'Open Cloudflare API Tokens ↗': 'Ouvrir Cloudflare API Tokens ↗',
      'Cloudflare API token': 'Jeton d’API Cloudflare',
      'Save & check': 'Enregistrer et vérifier',
      'Re-check': 'Revérifier',
      '(a token is saved — leave blank to keep it)': '(un jeton est enregistré — laissez vide pour le conserver)',
      'Not configured — the dashboard shows only what the tracking script recorded.': 'Non configuré — le tableau de bord n’affiche que ce que le script de mesure a enregistré.',
      'Saved. The first pull runs with tonight’s daily job.': 'Enregistré. La première récupération aura lieu lors de la tâche quotidienne de cette nuit.',
      'Last check failed': 'Dernière vérification en échec',
      'Last pull': 'Dernière récupération',
      'site-days': 'jours-site',
      'sites matched': 'sites appariés',
      'zones visible': 'zones visibles',
      'checking…': 'vérification…',
      'Could not verify that token.': 'Impossible de vérifier ce jeton.',
      'Token works. Matched {n} site(s): ': 'Le jeton fonctionne. {n} site(s) apparié(s) : ',
      'Token works, but none of your sites are on a zone it can see. Check the token’s Zone Resources.': 'Le jeton fonctionne, mais aucun de vos sites ne se trouve dans une zone qu’il peut voir. Vérifiez les Zone Resources du jeton.',
      'Token removed.': 'Jeton supprimé.',
      'What the script never saw': 'Ce que le script n’a jamais vu',
      'Requests Cloudflare served for this site, next to the pageviews the tracking script reported. The difference is HTML that was fetched without ever running JavaScript — AI crawlers, scrapers and feed readers. Descriptive only: none of this affects scoring, verdicts or ad protection.': 'Requêtes servies par Cloudflare pour ce site, en regard des pages vues rapportées par le script de mesure. L’écart correspond au HTML récupéré sans jamais exécuter JavaScript — robots d’IA, scrapers et lecteurs de flux. Purement descriptif : rien de tout cela n’affecte le score, le verdict ni la protection publicitaire.',
      'Measure': 'Mesure',
      'Requests': 'Requêtes',
      'Edge HTML requests': 'Requêtes HTML edge',
      'Browser pageviews': 'Pages vues navigateur',
      'Gap — fetched, never ran JS': 'Écart — récupéré, JS jamais exécuté',
      'All edge requests (assets included)': 'Toutes les requêtes edge (ressources incluses)',
      'User agent': 'User-Agent',
      'Identified crawler traffic grouped by what the crawler is for. Classification only — these visits are scored exactly as before.': 'Trafic de robots identifiés, groupé par usage. Classification uniquement — ces visites sont notées exactement comme avant.',
      'Category': 'Catégorie',
      'Share': 'Part',
      ...
      'SEO tool': 'Outil SEO',
      'Ad verification': 'Vérification publicitaire',
    ...
    es: {
      ...
      'token-help': ' — credenciales de solo lectura para la CLI, el servidor MCP (para que su propio chatbot consulte estos datos) y otras integraciones. Se muestra una sola vez al crearse.',
      'Token name': 'Nombre del token',
      'Scope': 'Alcance',
      'All my sites': 'Todos mis sitios',
      'Create token': 'Crear token',
      'Copy it now — it cannot be shown again.': 'Cópielo ahora: no se volverá a mostrar.',
      'No tokens yet.': 'Aún no hay tokens.',
      'all sites': 'todos los sitios',
      'used': 'usado',
      'never used': 'nunca usado',
      'Revoke': 'Revocar',
      'Revoke this token? Anything using it stops working immediately.': '¿Revocar este token? Todo lo que lo use dejará de funcionar de inmediato.',
      'Could not create the token.': 'No se pudo crear el token.',
      'not your site': 'Ese sitio no es suyo',
      'Crawler directory': 'Directorio de rastreadores',
      'botdir-help': ' — opcional. Importe un catálogo público de bots para etiquetar el tráfico de rastreadores por tipo (búsqueda / entrenamiento de IA / SEO / anuncios). Solo clasificación: no afecta a la puntuación, el veredicto ni la protección de anuncios.',
      'Directory JSON file': 'Archivo JSON del directorio',
      '…or paste the JSON': '…o pegue el JSON',
      'Import directory': 'Importar directorio',
      'Remove': 'Eliminar',
      'No directory imported — crawler traffic is not categorised.': 'Sin directorio importado: el tráfico de rastreadores no se categoriza.',
      'bots imported': 'bots importados',
      'skipped': 'omitidos',
      'updated': 'actualizado',
      'Could not read that file.': 'No se pudo leer ese archivo.',
      'Choose a file or paste the JSON first.': 'Primero elija un archivo o pegue el JSON.',
      'That is not valid JSON.': 'Eso no es JSON válido.',
      'Import failed.': 'Error en la importación.',
      'no bot entries recognised in that file': 'no se reconoció ninguna entrada de bot en ese archivo',
      'Imported {n} bots.': '{n} bots importados.',
      'Directory removed.': 'Directorio eliminado.',
      'Crawlers by category': 'Rastreadores por categoría',
      'Cloudflare edge requests': 'Solicitudes en el edge de Cloudflare',
      'cf-help': ' — opcional, avanzado. El script de medición solo ve a los visitantes cuyo navegador ejecutó JavaScript. Los rastreadores de IA y los scrapers descargan tu HTML y se van, así que nunca aparecen. Cloudflare sí los contó a todos: añade un token de API de solo lectura y la tarea diaria traerá esos recuentos de solicitudes, para que tu panel pueda mostrar lo que el script no vio. Déjalo vacío y nada cambia.',
      'cf-steps': 'En el panel de Cloudflare: <b>My Profile → API Tokens → Create Token → Create Custom Token</b>. Concede exactamente estos dos permisos, ambos de solo lectura:',
      'cf-steps2': 'En <i>Zone Resources</i> elige las zonas donde están tus sitios (o todas las zonas de la cuenta), crea el token y pégalo abajo.',
      'Open Cloudflare API Tokens ↗': 'Abrir Cloudflare API Tokens ↗',
      'Cloudflare API token': 'Token de API de Cloudflare',
      'Save & check': 'Guardar y comprobar',
      'Re-check': 'Volver a comprobar',
      '(a token is saved — leave blank to keep it)': '(hay un token guardado — déjalo en blanco para conservarlo)',
      'Not configured — the dashboard shows only what the tracking script recorded.': 'Sin configurar — el panel solo muestra lo que registró el script de medición.',
      'Saved. The first pull runs with tonight’s daily job.': 'Guardado. La primera descarga se ejecutará con la tarea diaria de esta noche.',
      'Last check failed': 'La última comprobación falló',
      'Last pull': 'Última descarga',
      'site-days': 'días-sitio',
      'sites matched': 'sitios emparejados',
      'zones visible': 'zonas visibles',
      'checking…': 'comprobando…',
      'Could not verify that token.': 'No se pudo verificar ese token.',
      'Token works. Matched {n} site(s): ': 'El token funciona. {n} sitio(s) emparejado(s): ',
      'Token works, but none of your sites are on a zone it can see. Check the token’s Zone Resources.': 'El token funciona, pero ninguno de tus sitios está en una zona que pueda ver. Revisa las Zone Resources del token.',
      'Token removed.': 'Token eliminado.',
      'What the script never saw': 'Lo que el script nunca vio',
      'Requests Cloudflare served for this site, next to the pageviews the tracking script reported. The difference is HTML that was fetched without ever running JavaScript — AI crawlers, scrapers and feed readers. Descriptive only: none of this affects scoring, verdicts or ad protection.': 'Solicitudes que Cloudflare sirvió para este sitio, junto a las páginas vistas que informó el script de medición. La diferencia es HTML que se descargó sin ejecutar nunca JavaScript: rastreadores de IA, scrapers y lectores de feeds. Solo descriptivo: nada de esto afecta a la puntuación, el veredicto ni la protección de anuncios.',
      'Measure': 'Métrica',
      'Requests': 'Solicitudes',
      'Edge HTML requests': 'Solicitudes HTML en el edge',
      'Browser pageviews': 'Páginas vistas del navegador',
      'Gap — fetched, never ran JS': 'Diferencia: descargado, nunca ejecutó JS',
      'All edge requests (assets included)': 'Todas las solicitudes en el edge (recursos incluidos)',
      'User agent': 'User-Agent',
      'Identified crawler traffic grouped by what the crawler is for. Classification only — these visits are scored exactly as before.': 'Tráfico de rastreadores identificados agrupado por su finalidad. Solo clasificación: estas visitas se puntúan igual que antes.',
      'Category': 'Categoría',
      'Share': 'Proporción',
